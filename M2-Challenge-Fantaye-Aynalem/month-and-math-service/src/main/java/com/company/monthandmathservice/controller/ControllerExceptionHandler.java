...
//source for this code: class exercise.
...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY) //this error is (Http) 422
    ...
    public ResponseEntity<CustomErrorResponse> errorResponseResponseEntity(IllegalArgumentException e) {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<CustomErrorResponse> errorResponseResponseEntity(HttpMessageNotReadableException e) {
        CustomErrorResponse error = new CustomErrorResponse(HttpStatus.UNPROCESSABLE_ENTITY.toString(),"You must supply valid numbers");
        error.setStatus((HttpStatus.UNPROCESSABLE_ENTITY.value()));
        error.setTimestamp(LocalDateTime.now());
        ResponseEntity<CustomErrorResponse> responseEntity = new ResponseEntity<>(error,HttpStatus.UNPROCESSABLE_ENTITY);
        return responseEntity;
